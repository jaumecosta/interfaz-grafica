...
LABEL en las interfaces se encarganm de mucha scosas, ya sean traernos un texto, imagenes, etc. DEntro del main
no son iguales a los de HTML, el LABEL en si es un WIDGE
CREACION DE LABELS
...
Label(miFrame, text='Hola alumnos', fg='red',
      font=('Arial', 20)).place(x=250, y=10)
